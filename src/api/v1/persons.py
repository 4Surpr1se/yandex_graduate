...
async def search_persons(
    ...
    logging.info(
        f"API call: search_persons with query={query}, page_number={page_number}, page_size={page_size}")
...
async def get_films_by_person(uuid: str, request: Request, person_service: PersonService = Depends(get_person_service)) -> List[Film]:
